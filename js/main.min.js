...
},{"./modules/form-validate/form":3,"./modules/video/video":9,"./utils/ios-vh-fix":11,"./vendor":12,"./vendor/init-accordion":14,"./vendor/init-tabs":15}],2:[function(require,module,exports){
"use strict";
...
function initVideo() {
  ...
  var videoPlay = document.querySelector('.gym__video-play');
  if (!(video || videoPlay)) {
    return;
  }
...
function initSliders() {
  (0, _swiper.default)();
  var trainersSlider = new Swiper('.trainers__items', {
  ...
  var reviewsSlider = new Swiper('.reviews__items', {
    direction: 'horizontal',
    navigation: {
...
},{"./vendor/swiper":16}],13:[function(require,module,exports){
"use strict";
...
},{"./tabs":17}],16:[function(require,module,exports){
